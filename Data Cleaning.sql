...
SELECT SaleDateConvertedDate, CONVERT(date, SaleDate)
FROM PortfolioProject.dbo.NashvilleHousing
...
ALTER TABLE PortfolioProject.dbo.NashvilleHousing
ADD PropertySplitCityAddres nvarchar(255);

UPDATE PortfolioProject.dbo.NashvilleHousing
SET  PropertySplitCityAddres = SUBSTRING(PropertyAddress, CHARINDEX(',', PropertyAddress) +1, LEN(PropertyAddress))

SELECT *
FROM PortfolioProject.dbo.NashvilleHousing

SELECT PropertyAddress, PropertySplitAddres, PropertySplitCityAddres
FROM PortfolioProject.dbo.NashvilleHousing
